...
export default function LandingPage({ onGetStarted, onExploreFeatures, onPremiumClick, onFeatureSelect }) {
  return (
    <main className="flex min-h-screen w-full flex-col gap-12 overflow-x-hidden bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.18),transparent_30%),radial-gradient(circle_at_82%_16%,rgba(96,165,250,0.12),transparent_22%),linear-gradient(180deg,#edf5ff_0%,#f8fbff_48%,#f3f8ff_100%)] px-4 py-4 text-slate-900 sm:gap-16 sm:px-6 lg:gap-10 lg:px-8">
      <HeroSection
